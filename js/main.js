...
;(function(window) {
	...
	function GridSlideshow(el, options) {
		...
		this.nav = {
			...
			left : this.el.querySelector('.grid-nav > button.grid__button--left'),
			right : this.el.querySelector('.grid-nav > button.grid__button--right'),
			up : this.el.querySelector('.grid-nav > button.grid__button--up'),
			down : this.el.querySelector('.grid-nav > button.grid__button--down')
		},
	...
	GridSlideshow.prototype._initEvents = function() {
		...
		this.nav.left.addEventListener('click', function() { self._navigate('left'); });
		this.nav.right.addEventListener('click', function() { self._navigate('right'); });
		this.nav.up.addEventListener('click', function() { self._navigate('up'); });
		this.nav.down.addEventListener('click', function() { self._navigate('down'); });
